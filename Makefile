...
increment_filter_lock_test: init_build_folder
	...
	$(CXX) $(FILTER_LOCK_DEPENDENCIES) $(INCREMENT_TEST_FILES) $(LIBRARIES) -o $(OUTPUT_DIR)/$(FILTER_LOCK_INCREMENT_OUTPUT_NAME) $(DEBUG_FLAGS) $(ERROR_FLAGS)
	$(CXX) $(FILTER_LOCK_DEPENDENCIES) $(INCREMENT_TEST_FILES) $(LIBRARIES) -masm=intel -S -fverbose-asm -fno-asynchronous-unwind-tables -fno-exceptions
