...
\begin{lstlisting}[language=C,caption={Memory-reclamation scheme used in \citeauthor{michael1996simple}'s original implementation of the Valois' Queue},label={lst:ms_queue_memory}]
void
init_private()
{
