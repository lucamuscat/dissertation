...
{%backmatter % comment this out otherwise are not numbered
    ...
    {\scriptsize\bibliography{chap2/background_biblio,chap3/lit_review_related_work_biblio,chap4/design_and_implementation_biblio,chap5/evaluation_biblio}}
	\printindex
}

\appendix
	\input{appendix/source_code_main.tex}     % these are just test names as I didn't know what you'd want
	\input{appendix/interfaces.tex}    
